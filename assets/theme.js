...
theme.Product = (function() {
  function Product(container) {
    ...
    this.settings = {
      // Breakpoints from src/stylesheets/global/variables.scss.liquid
      mediaQueryMediumUp: 'screen',
      mediaQuerySmall: 'screen',
      bpSmall: false,
...
//addition  deliverdate
  ...
  $(document).ready( function() {
    $(function() {
     ...
     var headertop=$("#shopify-section-header");
 ...
 var scrollFunc=function(event){ 
    ...
    if(e.wheelDelta){//IE/Opera/Chrome 
	    ...
	    if($(window).scrollTop()>headHeight){ 
         headertop.addClass("navFixed");  
       }else{ 
         headertop.removeClass("navFixed");   
       } 
...
// addtion chekbox in the checout
